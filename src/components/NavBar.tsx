    ...
    <>
      ...
      <Transition show={show}>
        <div
          ...
          } max-md:hidden fixed w-full z-10 py-6 px-8 lg:px-[calc((100vw-1128px)/2)] flex flex-row justify-between items-center animate-slide-down ${
        ...
        >
          <div className="flex flex-row gap-8 lg:gap-12">
            ...
            <a
              ...
              target="_blank"
            >
              <p className="b2 text-neutral-900 dark:text-neutral-100">
                Resume
              </p>
            </a>
          </div>
